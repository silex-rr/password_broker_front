...
import {
    FIELD_ADDING_AWAIT
} from "../../../../../../../src_shared/passwordBroker/constants/EntryGroupEntryFieldAddingStates";
...
const EntryFieldAdd = ({
    ...
    switch (addingFieldType) {
            ...
            value = (
                <View style={tw`py-1.5 items-center`}>
                    <View style={tw`flex flex-row `}>
                        <Text htmlFor={"add-field-for-" + entryId + "-login"}
                    ...
                    <View style={tw`flex flex-row `}>
                        <Text htmlFor={"add-field-for-" + entryId + "-value"}
                               style={tw`inline-block basis-1/3 text-lg`}
                        >
                            Password:
                        </Text>
        ...
        case FIELD_TYPE_NOTE:
            value = (
                <View style={tw`py-1.5 items-center`}>
                    <TextInput onChangeText={changeValue} placeholder="type new note" value={addingFieldValue}
    ...
    if (masterPassword === '') {
        masterPasswordField = (
            <View style={tw`flex flex-row py-1.5 items-center`}>
                <Text
                       style={tw`inline-block basis-1/3 text-xl align-middle text`}
                >
                    MasterPassword:
                </Text>
                <TextInput
    ...
    return (
        <View style={tw`px-2 pb-2 w-full`} >
            ...
            <View style={tw`py-4`}>
                <View style={tw`flex flex-row py-1.5 items-center`}>
                    <Text htmlFor={"add-field-for-" + entryId + "-title"}
                            style={tw`inline-block basis-1/3 text-lg`}
                    >
                        Field Title:
                    </Text>
                    <TextInput id={"add-field-for-" + entryId + "-title"}
                ...
                <View style={tw`flex flex-row py-1.5 items-center`}>
                    <Text htmlFor={"add-field-for-" + entryId + "-type"}
                            style={tw`inline-block basis-1/3 text-lg`}
                    >
                        Field Type:
                    </Text>
                ...
                <View style={tw`flex flex-row justify-around w-full mt-12`}>
                    <Pressable onPress={sendFormHandler}

...
// import {ENTRY_GROUP_USERS_REQUIRED_LOADING}
...
const EntryGroupUsers = () => {
    ...
    //                         setMasterPasswordCallback(
    //                             masterPassword => sendRequest,
    //                         );
    //                         showMasterPasswordModal(
    //                             'MasterPassword is invalid',
    //                         );
    //                     }
    //                 },
    //             );
    ...
    //     remove_th = (
    //         <th className="bg-slate-900 text-slate-200">Remove user</th>
    //     );
    //     add_user = (
    ...
    return (
        ...
        //                 <th className="bg-slate-900 text-slate-200">
        //                     Role set
        //                 </th>
        //                 {remove_th}
        //             </tr>
